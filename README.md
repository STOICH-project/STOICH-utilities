...
## Getting Started
The STOICH database R package "stoichUtilities" is a set of functions to aid with tasks like filtering, pairing water samples with organism samples and merging tables. Since it is an R package you will need to have R installed. It is recommended to install RStudio (https://www.rstudio.com/) to help manage packages and provide an integrated development environment (IDE).
## Installation
...
### Option 1: Install via CRAN
The "stoichUtilities" has been submitted to CRAN and should be available soon to install via the R package manager.
```R
...
## Using the R Library
Additional examples are available at [Examples.pdf](https://github.com/STOICH-project/STOICH-utilities/blob/main/Additional%20Examples/Examples.pdf).
