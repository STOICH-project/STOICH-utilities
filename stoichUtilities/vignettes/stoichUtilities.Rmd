...
stoichData <- file.path(path.expand("~"), "data", "stoichdb", "currentDB")
stoichData <- stoichUtilities::loadSTOICH(dataPath=file.path(stoichData, max(list.files(stoichData))))
...
## Data Structure
![Data structure and relationship for STOICH data tables.](C:/Users/cpetersen4/Documents/GitHub/STOICHDatabase/docs/data_model_narrow.svg){#id .class width=70% height=70%}
